...
def main() -> None:
    with TestClient(app) as client:
        ...
        response = client.post("/imports/commit", files=_csv_upload(code))
        response.raise_for_status()
        ...
        report = client.post(f"/reports/{analysis.json()['id']}")
